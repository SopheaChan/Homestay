package com.example.homestay.helper;
...
public class QRHelper {
    private static QRHelper qrCodeHelper = null;
     ...
     */
    public static QRHelper newInstance(Context context) {
        if (qrCodeHelper == null) {
            qrCodeHelper = new QRHelper(context);
        }
        return qrCodeHelper;
    }
    /**
     ...
     */
    public QRHelper setErrorCorrectionLevel(ErrorCorrectionLevel level) {
     ...
     * @return the instance of QrCode helper class for to use remaining function in class.
     */
    public QRHelper setContent(String content) {
        mContent = content;
        return this;
    }
    /**
     ...
     * @return the instance of QrCode helper class for to use remaining function in class.
     */
    public QRHelper setWidthAndHeight(@IntRange(from = 1) int width, @IntRange(from = 1) int height) {
        mWidth = width;
        mHeight = height;
        return this;
    }
     ...
     * @return the instance of QrCode helper class for to use remaining function in class.
     */
    public QRHelper setMargin(@IntRange(from = 0) int margin) {
        mMargin = margin;
        return this;
    }
    /**
